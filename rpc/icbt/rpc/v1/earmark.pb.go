...
type Earmark struct {
	...
	EventItemRefId string                 `protobuf:"bytes,2,opt,name=event_item_ref_id,json=eventItemRefId" json:"event_item_ref_id,omitempty"`
	...
	Created        *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=created" json:"created,omitempty"`
...
type EarmarkCreateRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	EventItemRefId string                 `protobuf:"bytes,1,opt,name=event_item_ref_id,json=eventItemRefId" json:"event_item_ref_id,omitempty"`
	Note           string                 `protobuf:"bytes,2,opt,name=note" json:"note,omitempty"` // required, but can be empty
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type EarmarkCreateResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Earmark       *Earmark               `protobuf:"bytes,1,opt,name=earmark" json:"earmark,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type EarmarkGetDetailsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Earmark       *Earmark               `protobuf:"bytes,1,opt,name=earmark" json:"earmark,omitempty"`
	EventRefId    string                 `protobuf:"bytes,2,opt,name=event_ref_id,json=eventRefId" json:"event_ref_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_icbt_rpc_v1_earmark_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x66, 0x49, 0x64, 0x22, 0x7f, 0x0a, 0x13, 0x45, 0x61, 0x72,
	0x6d, 0x61, 0x72, 0x6b, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x21, 0x0a, 0x08, 0x61, 0x72, 0x63, 0x68, 0x69,
	0x76, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x42, 0x05, 0xaa, 0x01, 0x02, 0x08, 0x01,
	0x52, 0x08, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x64, 0x22, 0x8e, 0x01, 0x0a, 0x14, 0x45,
	0x61, 0x72, 0x6d, 0x61, 0x72, 0x6b, 0x73, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0xac, 0x01, 0x0a, 0x0f,
	0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x63, 0x62, 0x74, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x76, 0x31, 0x42,
	0x0c, 0x45, 0x61, 0x72, 0x6d, 0x61, 0x72, 0x6b, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
	...
	0x63, 0x3a, 0x3a, 0x56, 0x31, 0x92, 0x03, 0x02, 0x08, 0x02, 0x62, 0x08, 0x65, 0x64, 0x69, 0x74,
