...
const file_icbt_rpc_v1_timestamptz_proto_rawDesc = "" +
	"\n" +
	"\x1dicbt/rpc/v1/timestamptz.proto\x12\vicbt.rpc.v1\x1a\x1bbuf/validate/validate.proto\x1a!google/protobuf/go_features.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"X\n" +
	"\vTimestampTZ\x12*\n" +
	"\x02ts\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\x02ts\x12\x1d\n" +
	"\x02tz\x18\x02 \x01(\tB\r\xbaH\n" +
	"r\b\x10\x03\x92\x02\x03UTCR\x02tzB\xb5\x01\n" +
	"\x0fcom.icbt.rpc.v1B\x10TimestamptzProtoP\x01Z8github.com/dropwhile/icanbringthat/rpc/icbt/rpc/v1;rpcv1\xa2\x02\x03IRX\xaa\x02\vIcbt.Rpc.V1\xca\x02\vIcbt\\Rpc\\V1\xe2\x02\x17Icbt\\Rpc\\V1\\GPBMetadata\xea\x02\rIcbt::Rpc::V1\x92\x03\a\xd2>\x02\x10\x03\b\x02b\beditionsp\xe8\a"
...
func file_icbt_rpc_v1_timestamptz_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_icbt_rpc_v1_timestamptz_proto_rawDesc), len(file_icbt_rpc_v1_timestamptz_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
