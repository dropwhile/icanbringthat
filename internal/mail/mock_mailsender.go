...
func (_m *MockMailSender) Send(_a0 string, _a1 []string, _a2 string, _a3 string, _a4 string, _a5 MailHeader) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, []string, string, string, string, MailHeader) error); ok {
...
func (_c *MockMailSender_Send_Call) Run(run func(_a0 string, _a1 []string, _a2 string, _a3 string, _a4 string, _a5 MailHeader)) *MockMailSender_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]string), args[2].(string), args[3].(string), args[4].(string), args[5].(MailHeader))
	})
	return _c
}
...
func (_c *MockMailSender_Send_Call) RunAndReturn(run func(string, []string, string, string, string, MailHeader) error) *MockMailSender_Send_Call {
	_c.Call.Return(run)
	return _c
}

// SendAsync provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4, _a5
func (_m *MockMailSender) SendAsync(_a0 string, _a1 []string, _a2 string, _a3 string, _a4 string, _a5 MailHeader) {
...
func (_c *MockMailSender_SendAsync_Call) Run(run func(_a0 string, _a1 []string, _a2 string, _a3 string, _a4 string, _a5 MailHeader)) *MockMailSender_SendAsync_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].([]string), args[2].(string), args[3].(string), args[4].(string), args[5].(MailHeader))
	})
	return _c
...
func (_c *MockMailSender_SendAsync_Call) RunAndReturn(run func(string, []string, string, string, string, MailHeader)) *MockMailSender_SendAsync_Call {
	_c.Call.Return(run)
	return _c
}

// SendRaw provides a mock function with given fields: _a0
func (_m *MockMailSender) SendRaw(_a0 *Mail) error {
	ret := _m.Called(_a0)
...
func (_c *MockMailSender_SendRaw_Call) Run(run func(_a0 *Mail)) *MockMailSender_SendRaw_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*Mail))
	})
	return _c
...
func (_c *MockMailSender_SendRaw_Call) RunAndReturn(run func(*Mail) error) *MockMailSender_SendRaw_Call {
	_c.Call.Return(run)
	return _c
}
