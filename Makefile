...
.PHONY: pave-generated
pave-generated: setup
	@echo ">> Purging generated files..."
	@grep -lRE '^// Code generated by (.+). DO NOT EDIT' internal/app/modelx | xargs rm
...
check: setup setup-check
	...
	@go vet ./...
	@echo "... gosec ..."
	@${GOBIN}/gosec -quiet -exclude-generated -exclude-dir=cmd/refidgen ./...
	@echo "... govulncheck ..."
	@${GOBIN}/govulncheck ./...
	@echo "... sqlc diff ..."
	@${GOBIN}/sqlc diff
